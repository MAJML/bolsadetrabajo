                ...
                <div class="row">
                        ...
                        <div class="filter">
                            <div class="content-perfil">
                                <div class="imagen-perfil">
                                    <img src="{{ ($alumno != null && $alumno->foto != null) ?  "/uploads/alumnos/fotos/".$alumno->foto :
                                    "/uploads/default.png" }}" class="img-responsive" alt="Editar Foto">
                                    <input type="file" class="styled form-control" name="foto" id="foto" accept="image/jpeg, image/png" {{ $alumno != null ? "" : "required" }}>
                                </div>
                                <h5>{{ $alumno->nombres." ".$alumno->apellidos }}</h5>
                                <p>{{ ($alumno->egresado == \BolsaTrabajo\App::$TIPO_ALUMNO ? "Estudiante" : ($alumno->egresado == \BolsaTrabajo\App::$TIPO_TITULADO ? "Titulado" : "Egresado")) }}</p>
                                ...
                                <div class="hoja_de_vida_content">
                                    ...
                                    <div class="hoja_de_vida" hidden>
                                        <p> <span class="bold"> {{ ($alumno->hoja_de_vida != null && $alumno->hoja_de_vida != "") ? "Editar" : "Adjuntar" }} mi CV </span><br> <span>(*.pdf, *.doc)</span></p>
                                        <input type="file" class="styled form-control" name="hoja_de_vida" id="hoja_de_vida" accept="application/pdf, application/msword, .doc, .docx" {{ $alumno != null ? "" : "required" }}>
                                    </div>
                    ...
                    <div class="col-md-7">
                            ...
                            <div class="card aviso">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <div class="alert alert-danger">
                                                <p>Para poder postular a una oferta laboral es indispensable actualizar los siguientes datos en tu perfil: </p>
                                                <ul>
                                                    @foreach($errors as $q)
                                                        <li style="font-size: 13px">{{ $q }}</li>
                                                    @endforeach
                                                </ul>
                                                <p>Pulse el botón actualizar perfil para guardar toda su información personal, luego pulse el botón ver avisos para visualizar las ofertas laborales.</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <input type="text" class="form-input" name="dni" id="dni" minlength="8" maxlength="15" placeholder="DNI" onkeypress="return isNumberKey(event)" value="{{ $alumno->dni }}" required>
                                        <span data-valmsg-for="dni"></span>
                                    </div>
                                    <div class="col-md-6 mt-3">
                                        <label for="fecha_nacimiento">Fecha de Nacimiento</label>
                                        <input type="text" class="form-input" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $alumno->fecha_nacimiento)->format('d/m/Y') }}" placeholder="Fecha de Nacimiento" autocomplete="off" required>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <select name="provincia_id" id="provincia_id" class="form-input" required>
                                            ...
                                            @foreach($provincias as $q)
                                                <option value="{{ $q->id }}" {{ $alumno->provincia_id == $q->id ? "selected" : "" }}> {{ $q->nombre }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="distrito_id" id="distrito_id" class="form-input" required>
                                            ...
                                            @if(count($distritos) > 0)
                                                @foreach($distritos as $q)
                                                    <option value="{{ $q->id }}" {{ $alumno->distrito_id == $q->id ? "selected" : "" }}>{{ $q->nombre }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <input type="text" class="form-input" name="direccion" id="direccion" value="{{ $alumno->direccion }}" placeholder="Dirección" required>
                                        <span data-valmsg-for="telefono"></span>
                                    </div>
                                    <div class="col-md-6 mt-3">
                                        <label for="telefono">Teléfono</label>
                                        <input type="text" class="form-input" name="telefono" id="telefono" minlength="6" maxlength="15" value="{{ $alumno->telefono }}" placeholder="Teléfono" required>
                                        <span data-valmsg-for="telefono"></span>
                                    </div>
                                    <div class="col-md-6 mt-3">
                                        <label for="email">Correo electrónico</label>
                                        <input type="email" class="form-input" name="email" id="email" placeholder="Correo electrónico" value="{{ $alumno->email }}" required>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <select name="egresado" id="egresado" class="form-input">
                                            <option value="0" {{ $alumno->egresado == \BolsaTrabajo\App::$TIPO_ALUMNO ? "selected" : "" }}>Estudiante</option>
                                            <option value="1" {{ $alumno->egresado == \BolsaTrabajo\App::$TIPO_EGRESADO ? "selected" : "" }}>Egresado</option>
                                            <option value="2" {{ $alumno->egresado == \BolsaTrabajo\App::$TIPO_TITULADO ? "selected" : "" }}>Titulado</option>
                                        </select>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <select name="area_id" id="area_id" class="form-input" required>
                                            ...
                                            @foreach($areas as $q)
                                                <option value="{{ $q->id }}" {{ $alumno->area_id == $q->id ? "selected" : "" }}>{{ $q->nombre }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <label for="">Perfil Profesional</label> <a class="btn_ejemplo_perfil" href="{{ asset('app/img/perfil_word.pdf') }}" target="_blank">Ver Ejemplo</a>
                                        <input type="text" class="form-input" name="perfil_profesional" id="perfil_profesional" placeholder="Redacte su perfil Profesional" value="{{ strip_tags($alumno->perfil_profesional) }}" required>
                                ...
                                <div style="display: flex; justify-content:center; width:50%; margin:0 auto; ">
                                    ...
                                    <a style="width:100px; margin-top:0px" class="btn_ejemplo_perfil" href="{{ asset('app/img/EXPERIENCIA_LABORAL2.pdf') }}" target="_blank">Ver Ejemplo</a>
                                </div>
                                ...
                                <div id="content_educacion">
                                    @foreach($educaciones as $q)
                                        <div class="info-content">
                                            ...
                                            <p><b>Programa de estudio:</b> {{ $q->areas != null ? $q->areas->nombre : "-" }}</p>
                                            <p><b>Estado:</b> {{ $q->estado }}</p>
                                ...
                                <hr>
                                {{-- {{ $referenciaLaboral }} --}}
                                <div style="display: flex; justify-content:center; width:50%; margin:0 auto; align-items:center">
                                    <h5 class="text-center text-uppercase titulo-adiciones">Formación Complementaria o Información Adicional</h5>
                                    <a style="width:100px; margin-top:0px" class="btn_ejemplo_perfil" href="{{ asset('app/img/FORMACIÓN_COMPLEMENTARIA.pdf') }}" target="_blank">Ver Ejemplo</a>                                    
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col md-12 mt-2">
                                        ...
                                        <a style="width:100px; margin-top:0px" class="btn_ejemplo_perfil" href="{{ asset('app/img/HABILIDADES.pdf') }}" target="_blank">Ver Ejemplo</a>
                                        <textarea style="" name="referentes_carrera" id="habilidades_conoci" cols="3" rows="3" class="form-input" placeholder="Redacte que conocimientos posee sobre su carrera">{{ $alumno->referentes_carrera }}</textarea>
                                    </div>
                                </div>

                                <hr>

                                {{-- <h5 class="text-center text-uppercase titulo-adiciones">Cursos o Talleres</h5>
                                <div id="experienciaLaboral" class="info-adiciones">
                                    <div id="">
                                    </div>
                                    <a href="javascript:void(0)" data-info="agregarExperienciaLaboral">Agregar Cursos</a>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <select name="disponibilidad" id="disponibilidad" class="form-input">
                                                <option value="">--Seleccione--</option>
                                                <option value="1" {{ $alumno->disponibilidad == 1 ? "selected" : "" }}>Tiempo completo</option>
                                                <option value="2" {{ $alumno->disponibilidad == 2 ? "selected" : "" }}>Medio tiempo</option>
                                                <option value="3" {{ $alumno->disponibilidad == 3 ? "selected" : "" }}>Solo Mañana</option>
                                                <option value="4" {{ $alumno->disponibilidad == 4 ? "selected" : "" }}>Solo Tarde y noche</option>
                                                <option value="5" {{ $alumno->disponibilidad == 5 ? "selected" : "" }}>Solo fines de semana</option>
                                            </select>
                                            <span data-valmsg-for="egresado"></span>
                                        </div>
                                    </div>
                            ...
                            <div class="card aviso mt-2">
                                ...
                                <a href="pdf" class="btn_cv" target="_blank"> Descargar mi CV </a>
