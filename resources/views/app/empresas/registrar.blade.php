                        ...
                        <div class="card aviso">
                            ...
                            <div id="datos_del_paciente" hidden>
                                ...
                                {{-- <div class="form-group row" id="">
                                    <div class="col-md-12">
                                        <textarea name="evidencias_paciente" id="evidencias" class="form-input" cols="30" rows="5">
                                            <b>Carga evidencias:</b><br><br><br>
                                            <b>Diagnóstico médico:</b><br><br><br>
                                            <b>Recetas:</b><br><br><br>
                                        </textarea>
                                    </div>
                                </div> --}}
