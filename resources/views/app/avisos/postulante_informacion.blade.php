                ...
                <div class="col-md-3 filter-cont">
                    <div class="filter">
                        <div class="info-group">
                            <p> Postulantes <br> <span id="count_postulantes">{{ count($alumnosAvisos->where('estado_id', \BolsaTrabajo\App::$ESTADO_POSTULANTES)->pluck('aviso_id')->toArray()) }}</span> </p>
                            <p> Evaluando <br> <span id="count_evaluados">{{ count($alumnosAvisos->where('estado_id', \BolsaTrabajo\App::$ESTADO_EVALUANDO)->pluck('aviso_id')->toArray()) }}</span> </p>
                            ...
                            <p> Aceptados <br> <span id="count_aceptados">{{ count($alumnosAvisos->where('estado_id', \BolsaTrabajo\App::$ESTADO_ACEPTADOS)->pluck('aviso_id')->toArray()) }}</span> </p>
                            <p> Desacartados <br> <span id="count_descartados">{{ count($alumnosAvisos->where('estado_id', \BolsaTrabajo\App::$ESTADO_DESCARTADOS)->pluck('aviso_id')->toArray()) }}</span> </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                        ...
                        <div class="form-group">
                            <div class="formulario">
                                <select id="clasificacion_id" name="clasificacion_id" class="form-input">
                                    ...
                                    <option value="{{ $q->id }}" {{ ($postulante != null && $postulante->estado_id == $q->id) ? "selected" : "" }}>{{ $q->nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
